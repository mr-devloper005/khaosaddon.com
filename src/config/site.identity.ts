export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'khaosaddon',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Khaos Addon',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'khaosaddon.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://khaosaddon.com',
